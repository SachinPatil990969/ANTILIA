...
class membersModel(baseModel):
    ...
    def save(self, *args, **kwargs):
        self.first_name = helpers.textLower(self.first_name)
        self.last_name = helpers.textLower(self.last_name)
        self.email = helpers.textLower(self.email)
        self.mobile = helpers.textLower(self.mobile)
